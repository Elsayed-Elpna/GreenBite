...
"""
def waste_prompt(meal_name, ingredients):
    return f"""
Return VALID JSON only.

Analyze the following ingredients and list ONLY non-eatable waste parts.

Ingredients:
{", ".join(ingredients)}

Rules:
- Only inedible parts (peel, shell, bone, seed)
- If no waste exists, return empty list
- No explanations
...
#     Generate EXACTLY 5 recipes using ONLY these ingredients:<<INGREDIENTS>>
